              ...
              <div class="card">
                <img src="images/sandra.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    ...
                    <p class="card-text">Teacher: Mrs. Sandra P. Baliquia</p>
              ...
              <div class="card">
                <img src="images/Grace.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    ...
                    <p class="card-text">Teacher: Mrs. Grace C. Madeja</p>
                    <a href="students.php" class="btn btn-primary">View</a>
                  </div>
              </div>
            </div>
              ...
              <div class="card">
                <img src="images/Catheryn.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    ...
                    <p class="card-text">Teacher: Mrs. Catheryn M. Lobenia</p>
                    <a href="students.php" class="btn btn-primary">View</a>
                  </div>
              </div>
            </div>
              ...
              <div class="card">
                <img src="images/Cris.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    ...
                    <p class="card-text">Teacher: Mrs. Maria Crisanta G. Chua</p>
                    <a href="students.php" class="btn btn-primary">View</a>
                  </div>
              </div>
            </div>
              ...
              <div class="card">
                <img src="images/nona.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    ...
                    <p class="card-text">Teacher: Mrs. Nona M. Jaromay</p>
                    <a href="students.php" class="btn btn-primary">View</a>
                  </div>
              </div>
            </div>
              ...
              <div class="card">
                <img src="images/magdalena.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    ...
                    <p class="card-text">Teacher: Mrs. Magdalena G. Picardo</p>
                    <a href="students.php" class="btn btn-primary">View</a>
                  </div>
              </div>
            </div>
