    ...
    <div class ="jumbotron">
      <div class="card my-3">
        ...
        <div class="card-body">
          ...
          <?php
          $query2 = "SELECT * FROM submitassignments ";
          $run2 = mysqli_query($con,$query2);
               
          while($rows = mysqli_fetch_assoc($run2)){
          ?>
          <a href="downloadassignment.php?file=<?php echo $rows['submittedassignment'] ?>" class= "button" class="btn btn-secondary" >  <?php echo $rows['submittedassignment'] ?> </a><br>
          <?php
          }
          ?>
