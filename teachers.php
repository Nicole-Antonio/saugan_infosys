  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="form-group m-3">
         ...
         <input type="text" class="form-control" name="advisory" placeholder="Enter advisory level">
      </div>
      </div>
...
<div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="form-group m-3">
         <label>Advisory Class</label>
         <input type="text" class="form-control" name="advisory" id="advisory" placeholder="Enter advisory class">
      </div>
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Delete Teacher Information </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </button>
                </div>
...
<!----##############################################################################################################--->
  ...
  <div class="container">
    <div class ="jumbotron">
      ...
      <div class="card">
        <div class="card-body">
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#teacheraddmodal">
            Add teacher
          </button>
        </div>
      </div>
