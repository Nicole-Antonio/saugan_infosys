...
<head>
	...
	<link rel="stylesheet" type="text/css" href="submittedassignments.css">
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="deletesubmittedassignments.php" method="POST">
			...
			<div class="card my-3">
				...
				<div class="card">
					<div class="card-body">
						...
						<table id="datatableid" class="table" class="table-bordered">
							  <thead>

							    <tr>

							    	<?php
										$query = "SELECT * from `submitassignments`";
							  		...
							  		<tbody>
							    		<tr>
							      		...
							      		<td><?php echo $row['submittedassignment']; ?></td>
							      	<td>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <a href="downloadassignments.php">
