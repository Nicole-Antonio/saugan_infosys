                ...
                <img src="images/quiz.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                   <h5 class="card-title">Quizzes</h5>
                    ...
                    <a href="allquizzes.php" class="btn btn-primary">View</a>
                  </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card">
                <img src="images/test.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    ...
                    <a href="alltests.php" class="btn btn-primary">View</a>
                  </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card">
                <img src="images/report-card.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    ...
                    <a href="student_list.php" class="btn btn-primary">View</a>
                  </div>
              </div>
            </div>
        </div>
