      ...
      <div class="card my-3">
        ...
        <div class="modal fade" id="mymodal">
          ...
          <div class="modal-header">
            ...
            <form action="addsubjectmain.php" method="POST" enctype="multipart/form-data">
             
              <div class="modal-body">
                <div class="form-group">
                  <label for="lessons">Title</label>
                  <input type="text" class="form-control" placeholder="Enter lesson title" name="lessons">
                </div> 

                <div class="form-group">
                  <label for="lessons">Subject</label>
                  <input type="text" class="form-control" placeholder="Enter subject" name="subject">
                </div>

                <div class="form-group">
                  <label> Upload File </label>
                  <input type="file" name="filename" class="form-control" placeholder="Enter file">
                </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="savedata" 
                >Save data
                </button>
              </div>
            </form>
          ...
          <a href="submittedassignments.php">
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="deletesubjectmain.php" method="POST">
...
<!----###################################################################################--->
        ...
        ?>
          ...
          <?php
            $query = "SELECT * from `updatemodule`";
          ...
          ?>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <button type="button" value="<?php echo $row['id']; ?>" class="btn btn-danger deletebtn">Remove</button>
                    </td>
                  </tr>
                </tbody>
