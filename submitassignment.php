            ...
            <form action="assignment.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="lname" class="form-control" placeholder="Enter file">
                </div>


                <div class="form-group">
                  <label> Upload File </label>
                  <input type="file" name="submittedassignment" class="form-control" placeholder="Enter file">
                </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="insertassignment" 
                >Submit
                </button>
              </div>
            </form>
