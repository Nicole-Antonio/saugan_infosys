...
<div class="modal fade" id="studentimportmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="overall1upload.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<div class="form-group m-3">
			  ...
			  <input type="text" class="form-control" name="first_qtr" id="first_qtr" placeholder="Enter grade">
			</div>

			<div class="form-group m-3">
			   <label>2nd Quarter</label>
			   <input type="text" class="form-control" name="second_qtr" id="second_qtr" placeholder="Enter grade">
			</div>

			<div class="form-group m-3">
			   <label>3rd Quarter</label>
			   <input type="text" class="form-control" name="third_qtr" id="third_qtr" placeholder="Enter grade">
			</div>
			<div class="form-group m-3">
			   <label>4th Quarter</label>
			   <input type="text" class="form-control" name="fourth_qtr" id="fourth_qtr" placeholder="Enter grade">
			</div>
			<div class="form-group m-3">
			   <label>Final Grade</label>
			   <input type="text" class="form-control" name="final_grade" id="final_grade" placeholder="Enter grade">
			</div>
			<div class="form-group m-3">
			   <label>Remarks</label>
