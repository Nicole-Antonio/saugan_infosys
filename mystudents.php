...
<div class="modal fade" id="studentaddmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="addmystudent.php" method="POST">
      <div class="modal-body">
			...
			<div class="form-group m-3">
			   ...
			   <input type="number" class="form-control" name="gradelvl" placeholder="Enter grade level">
			</div>
      </div>
...
<div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="editmystudent.php" method="POST">
      <div class="modal-body">
			<div class="form-group m-3">
			...
			<div class="form-group m-3">
			   <label>Grade Level</label>
			   <input type="number" class="form-control" name="gradelvl" id="gradelvl" placeholder="Enter grade level">
			</div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="deletemystudent.php" method="POST">
