...
<div class="modal fade" id="studentimportmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="testsupload.php" method="POST" enctype="multipart/form-data">
      	...
      	<div class="modal-footer">
        	...
        	<button type="submit" name="insertdata" class="btn btn-primary">Import data</button>
      	</div>
...
<div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="edittests.php" method="POST">
      <div class="modal-body">
			<div class="form-group m-3">
			  ...
			  <input type="number" class="form-control" name="stud_id" id="stud_id" placeholder="Enter Student ID">
			</div>
			...
			<div class="form-group m-3">
			   <label>Score</label>
			   <input type="number" class="form-control" name="score" id="score" placeholder="Enter score">
			</div>

			<div class="form-group m-3">
			   <label>Items</label>
			   <input type="number" class="form-control" name="items" id="items" placeholder="Enter number of items">
			</div>
			<div class="form-group m-3">
			   <label>Date</label>
			   <input type="text" class="form-control" name="dateposted" id ="dateposted" placeholder="Enter date">
			</div>
			<div class="form-group m-3">
			   <label>Test No.</label>
			   <input type="number" class="form-control" name="test_no" id="test_no" placeholder="Enter test number">
			</div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="deletetests.php" method="POST">
