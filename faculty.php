...
<div class="container">
        ...
        <div class ="row g-3">
           <div class="col-12 col-md-6 col-lg-4">
              <div class="card">
                <img src="images/lota.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title" style="text-align: center;">Mrs. Lota Guial Obias</h5>
                    <p class="card-text" style="text-align: center;">Principal 1</p>
                    <a href="https://www.facebook.com/lota.guial" class="btn btn-primary" style="width: 100%;">View</a>
                  </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card">
                <img src="images/magdalena.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title" style="text-align: center;">Mrs. Magdalena G. Picardo</h5>
                    <p class="card-text" style="text-align: center;">Kindergarten Teacher</p>
                    <a href="https://www.facebook.com/magdalena.picardo/friends" class="btn btn-primary" style="width: 100%;">View</a>
                  </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card">
                <img src="images/sandra.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title" style="text-align: center;">Mrs. Sandra P. Baliquia</h5>
                    <p class="card-text" style="text-align: center;">Grade 1 Teacher</p>
                    <a href="https://www.facebook.com/sandra.baliquia" class="btn btn-primary" style="width: 100%;">View</a>
                  </div>
              </div>
            </div>
          </div>
          <div class ="row g-3">
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card">
                <img src="images/Grace.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title" style="text-align: center;">Mrs. Grace C. Madeja</h5>
                    <p class="card-text" style="text-align: center;">Grade 2 Teacher</p>
                    <a href="https://www.facebook.com/grace.madeja.98" class="btn btn-primary" style="width: 100%;">View</a>
                  </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card">
                <img src="images/Catheryn.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title" style="text-align: center;">Mrs. Catheryn M. Lobenia</h5>
                    <p class="card-text" style="text-align: center;">Grade 3 Teacher</p>
                    <a href="https://www.facebook.com/julianlobeniaII" class="btn btn-primary" style="width: 100%;">View</a>
                  </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card">
                <img src="images/Cris.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title" style="text-align: center;">Mrs. Crisanta G. Chua</h5>
                    <p class="card-text" style="text-align: center;">Grade 4 Teacher</p>
                    <a href="https://www.facebook.com/maricris.gulpric" class="btn btn-primary" style="width: 100%;">View</a>
                  </div>
              </div>
            </div>
          </div>
          <div class ="row g-3">
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card">
                <img src="images/nona.png" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title" style="text-align: center;">Mrs. Nona M. Jaromay</h5>
                    <p class="card-text" style="text-align: center;">Grade 5 and 6 Teacher</p>
                    <a href="#https://www.facebook.com/nona.jaromay.5" class="btn btn-primary" style="width: 100%;">View</a>
                  </div>
              </div>
            </div>
        </div>
...
<!----------------SIDEBAR-------------------> 
      ...
      <div id="sidebar">
        ...
        <a href="subjectmanagement.php" class="sidebar-item">
          ...
          <a href="profile_admin.php" class="sidebar-item">
